...
IMAGES=$1
CHECK_SUM=$2
[[ ! -f $IMAGES || ! -f $CHECK_SUM ]] && echo "Debes ingresar dos archivos." && exit 0
...
[[ "$CORRECT_SUM" == "$SUM" ]] && echo "Suma de verificación realizada correctamente!" || { echo "Archivo a descomprimir incorrecto"; exit 0; }
